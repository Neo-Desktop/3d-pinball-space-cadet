...
//----- (0100C335) --------------------------------------------------------
int __stdcall SpecialAddScore(int a1)
{
...
v1 = dword_1025040;
v2 = *(_DWORD *)((char *)dword_1025040 + 318);
*(_DWORD *)((char *)dword_1025040 + 318) = 0;
v3 = *(_DWORD *)((char *)v1 + 310);
*(_DWORD *)((char *)v1 + 310) = 0;
v4 = *(_DWORD *)((char *)v1 + 294);
*(_DWORD *)((char *)v1 + 294) = 0;
result = TPinballTable::AddScore(v1, a1);
v6 = dword_1025040;
*(_DWORD *)((char *)dword_1025040 + 310) = v3;
*(_DWORD *)((char *)v6 + 294) = v4;
*(_DWORD *)((char *)v6 + 318) = v2;
return result;
}

//----- (0100E50B) --------------------------------------------------------
int __stdcall AddRankProgress(int a1)
{
signed int v1; // ebx
int v2; // edi
...
signed int v4; // edi
int v5; // eax
int (__thiscall ***v6)(_DWORD, signed int, _DWORD); // esi
int v7; // edi
CHAR *v8; // ST40_4
CHAR *v9; // eax
__int64 v10; // rax
...
v1 = 0;
(**(void (__stdcall ***)(signed int, _DWORD))dword_10238F0)(19, 0.0);
v2 = a1;
v3 = (void (__thiscall ***)(_DWORD, signed int, _DWORD))dword_1023CFC;
if ( a1 > 0 )
{
do
{
...
v4 = ((int (__thiscall *)(_DWORD, signed int, _DWORD))**v3)(v3, 37, 0.0);
v5 = ((int (__thiscall *)(_DWORD, signed int, _DWORD))**v3)(v3, 38, 0.0);
if ( v4 == v5 )
{
v1 = 1;
(**v3)(v3, 16, 5.0);
v6 = (int (__thiscall ***)(_DWORD, signed int, _DWORD))dword_1023CF4;
...
(**(void (__fastcall ***)(int, int, signed int, _DWORD))dword_1023CF4)(dword_1023CF4, v11, 27, -1.0);
}
return v1;
}
...
v2 = (_DWORD *)memoryallocate(0x44u);
if ( !v2 )
return 0;
*v2 = -9999;
v2[2] = a2;
v3 = (__int16 *)partman_field_labeled(loader_table, lpString, 10);
if ( !v3 )
{
memoryfree((int)v2);
return 0;
...
do
{
if ( *(_DWORD *)((char *)score_msg_fontp + v0) )
{
gdrv_destroy_bitmap(*(_DWORD *)((char *)score_msg_fontp + v0));
memoryfree(*(_DWORD *)((char *)score_msg_fontp + v0));
}
v0 += 4;
}
while ( v0 < 520 );
...
if ( !result )
return result;
v3 = (signed __int16 *)LockResource(result);
v22 = (int)(v3 + 67);
...
v23 = 0;
*(_DWORD *)score_msg_fontp = *v3;
*((_DWORD *)score_msg_fontp + 1) = v3[2];
lpNamea = (LPCSTR)8;
while ( 1 )
{
v8 = (char *)v3 + v23 + 6;
...
*(_DWORD *)((char *)score_msg_fontp + (_DWORD)lpNamea) = memoryallocate(0x25u);
v9 = *(_DWORD *)((char *)score_msg_fontp + (_DWORD)lpNamea);
if ( !v9 )
goto LABEL_19;
...
v17 = *((char *)v3 + v23 + 6);
v21 = (char *)(v19 + 4);
v12 = *(_DWORD **)((char *)score_msg_fontp + (_DWORD)lpNamea);
v13 = -v12[5];
...
v15 = 4 * v23 + 8;
memoryfree(*(_DWORD *)((char *)score_msg_fontp + v15));
*(_DWORD *)((char *)score_msg_fontp + v15) = 0;
LABEL_19:
if ( v23 != 128 )
