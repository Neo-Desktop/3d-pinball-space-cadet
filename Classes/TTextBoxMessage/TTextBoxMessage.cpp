...
*(_DWORD *)this = 0;
*((float *)this + 2) = a3;
*((_DWORD *)this + 3) = time_ticks - (unsigned __int64)(signed __int64)(a3 * -1000.0);
if ( a2 )
*((_DWORD *)this + 1) = memoryallocate(strlen(a2) + 1);
else
*((_DWORD *)this + 1) = 0;
v4 = (char *)*((_DWORD *)v3 + 1);
if ( v4 )
...
{
return (double)(*((_DWORD *)this + 3) - time_ticks) * 0.001;
}
// 1024F84: using guessed type int time_ticks;
...
{
*((float *)this + 2) = a2;
*((_DWORD *)this + 3) = time_ticks - (unsigned __int64)(signed __int64)(a2 * -1000.0);
}
// 1024F84: using guessed type int time_ticks;
