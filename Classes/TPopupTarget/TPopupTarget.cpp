...
*((_BYTE *)a2 + 5) = 1;
render_sprite_set_bitmap(*(_DWORD **)((char *)a2 + 26), *(_DWORD *)(*(_DWORD *)(v2 + 4) + 8));
if ( a1 )
{
v3 = *(_DWORD *)((char *)a2 + 70);
if ( v3 )
...
*((_BYTE *)this + 5) = 0;
render_sprite_set_bitmap((_DWORD *)v8, SHIDWORD(v8));
break;
case 50:
*(_DWORD *)((char *)this + 78) = timer_set(
*(float *)((char *)this + 82),
(int)this,
(int)TPopupTarget::TimerExpired);
break;
case 1020:
*(_DWORD *)((char *)this + 4 * *(_DWORD *)(*(_DWORD *)((char *)this + 30) + 218) + 98) = *(_DWORD *)((char *)this + 6);
v7 = *(_DWORD *)((char *)this + 4 * (unsigned __int64)(signed __int64)_floor(a3) + 98);
*(_DWORD *)((char *)v3 + 6) = v7;
TPopupTarget::Message(v3, 50 - (v7 != 0), 0.0);
break;
case 1024:
v4 = *(_DWORD *)((char *)this + 30);
*(_DWORD *)((char *)this + 6) = 0;
v5 = 0;
if ( *(_DWORD *)(v4 + 214) > 0 )
{
v6 = (_DWORD *)((char *)v3 + 98);
do
{
*v6 = 0;
++v5;
...
(**(void (__thiscall ***)(TPopupTarget *, signed int, _DWORD))v6)(v6, 49, 0.0);
