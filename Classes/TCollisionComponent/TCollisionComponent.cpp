...
float *v8; // ecx
TCircle *v9; // eax
struct TCollisionComponent *v10; // edi
float v11; // ST14_4
TCircle *v12; // esi
TLine *v13; // eax
double v14; // st7
...
|| v26 < 0.0 && a5 < 0.0 )
{
v18 = (TCircle *)operator new(0x25u);
if ( v18 )
{
v19 = a5 * 1.001;
...
//----- (01017E85) --------------------------------------------------------
void __thiscall TCollisionComponent::Collision(TCollisionComponent *this, struct TBall *a2, struct vector_type *a3, struct vector_type *a4, float a5, struct TEdgeSegment *a6)
{
TCollisionComponent *v6; // esi
double v7; // st7
int v8; // esi
...
//----- (01017F29) --------------------------------------------------------
int __thiscall TCollisionComponent::DefaultCollision(TCollisionComponent *this, struct TBall *a2, struct vector_type *a3, struct vector_type *a4)
{
