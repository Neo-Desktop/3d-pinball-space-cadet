...
{
*(_DWORD *)((char *)this + 102) = a2;
*(_DWORD *)((char *)this + 66) = 1315859240;
*(_DWORD *)((char *)this + 78) = 1;
*(_DWORD *)((char *)a2 + 106) = this;
*(_DWORD *)((char *)a2 + 42) = *(_DWORD *)((char *)this + 110);
*(_DWORD *)((char *)a2 + 46) = *(_DWORD *)((char *)this + 114);
*(_DWORD *)((char *)this + 126) = *(_DWORD *)((char *)a2 + 50);
*(_DWORD *)((char *)a2 + 50) = *(_DWORD *)((char *)this + 98);
if ( *(_DWORD *)(*(_DWORD *)((char *)this + 30) + 370) )
{
(**(void (__thiscall ***)(TKickout *, signed int, _DWORD))this)(this, 55, 0.1);
}
else
{
...
//----- (010167BE) --------------------------------------------------------
void __stdcall TKickout::ResetTimerExpired(int a1, void *a2)
{
...
//----- (010167DD) --------------------------------------------------------
void __stdcall TKickout::TimerExpired(int a1, void *a2)
{
double v2; // st7
float v3; // ST08_4
int v4; // eax
...
*(_DWORD *)((char *)a2 + 78) = 0;
v3 = v2;
*(_DWORD *)((char *)a2 + 86) = timer_set(v3, (int)a2, (int)TKickout::ResetTimerExpired);
v4 = *(_DWORD *)((char *)a2 + 102);
if ( v4 )
{
v5 = *(_DWORD *)((char *)a2 + 126);
...
*(_DWORD *)((char *)this + 86) = timer_set(a3, (int)this, (int)TKickout::TimerExpired);
}
}
else
{
...
result = *(_DWORD *)((char *)this + 4 * a2 + 166);
return result;
}
...
if ( !a4 )
*((_BYTE *)v4 + 5) = 0;
*(_DWORD *)((char *)v4 + 90) = 1069547520;
*(_DWORD *)((char *)v4 + 94) = 1028443341;
*(_DWORD *)((char *)v4 + 6) = 0;
*(_DWORD *)((char *)v4 + 86) = 0;
*(_DWORD *)((char *)v4 + 78) = 0;
v30 = *(float *)loader_query_float_attribute(a3, 0, 306);
*(_DWORD *)((char *)v4 + 106) = *(_DWORD *)loader_query_float_attribute(a3, 0, 305);
loader_query_visual(a3, 0, &v15);
*(_DWORD *)((char *)v4 + 70) = v17;
*(_DWORD *)((char *)v4 + 74) = v24;
v5 = v16;
...
v10 = v19 * 0.01;
*(_DWORD *)((char *)v4 + 98) = *(_DWORD *)(v9 + 8);
v11 = v23;
*(float *)((char *)v4 + 150) = v10;
*(_DWORD *)((char *)v4 + 130) = v20;
*(_DWORD *)((char *)v4 + 134) = v21;
*(_DWORD *)((char *)v4 + 142) = v11;
v12 = v18;
*(_DWORD *)((char *)v4 + 138) = v22;
*(_DWORD *)((char *)v4 + 146) = v12;
v29 = *(_DWORD *)((char *)v4 + 122);
v26 = *(_DWORD *)((char *)v4 + 110);
v27 = *(_DWORD *)((char *)v4 + 114);
*(_DWORD *)((char *)v4 + 154) = (char *)v4 + 5;
v13 = v25;
v28 = *(_DWORD *)((char *)v4 + 118);
*(_DWORD *)((char *)v4 + 162) = v4;
*(_DWORD *)((char *)v4 + 158) = v13;
