...
v2 = *(void (__stdcall ****)(signed int, _DWORD))((char *)a2 + 30);
...
//----- (01016D8D) --------------------------------------------------------
void __stdcall TDemo::UnFlipRight(int a1, void *a2)
{
if ( *(_DWORD *)((char *)a2 + 98) )
(***(void (__stdcall ****)(signed int, _DWORD))((char *)a2 + 30))(1003, LODWORD(time_next));
*(_DWORD *)((char *)a2 + 98) = 0;
}
// 1025634: using guessed type float time_next;

//----- (01016DC0) --------------------------------------------------------
void __stdcall TDemo::UnFlipLeft(int a1, void *a2)
{
if ( *(_DWORD *)((char *)a2 + 94) )
(***(void (__stdcall ****)(signed int, _DWORD))((char *)a2 + 30))(1001, LODWORD(time_next));
*(_DWORD *)((char *)a2 + 94) = 0;
}
// 1025634: using guessed type float time_next;

//----- (01016DF3) --------------------------------------------------------
void __stdcall TDemo::FlipRight(int a1, void *a2)
{
double v2; // st7
float v3; // ST08_4
...
if ( !*(_DWORD *)((char *)a2 + 98) )
{
if ( *(_DWORD *)((char *)a2 + 106) )
{
timer_kill(*(_DWORD *)((char *)a2 + 106));
*(_DWORD *)((char *)a2 + 106) = 0;
}
(***(void (__stdcall ****)(signed int, _DWORD))((char *)a2 + 30))(1002, LODWORD(time_next));
...
//----- (01016E70) --------------------------------------------------------
void __stdcall TDemo::FlipLeft(int a1, void *a2)
{
double v2; // st7
float v3; // ST08_4
...
if ( !*(_DWORD *)((char *)a2 + 94) )
{
if ( *(_DWORD *)((char *)a2 + 102) )
{
timer_kill(*(_DWORD *)((char *)a2 + 102));
*(_DWORD *)((char *)a2 + 102) = 0;
}
(***(void (__stdcall ****)(signed int, _DWORD))((char *)a2 + 30))(1000, LODWORD(time_next));
v2 = *(float *)((char *)a2 + 86) + *(float *)((char *)a2 + 90);
*(_DWORD *)((char *)a2 + 94) = 1;
v3 = v2 - (double)_rand() * 0.00003051850947599719 * (*(float *)((char *)a2 + 90) + *(float *)((char *)a2 + 90));
...
//----- (01016EED) --------------------------------------------------------
void __stdcall TDemo::NewGameRestartTimer(int a1, void *a2)
{
int v2; // ecx
float v3; // ST04_4
...
(**(void (__stdcall ***)(signed int, _DWORD))v2)(1014, LODWORD(v3));
*(_DWORD *)((char *)a2 + 114) = 0;
}
...
if ( v13 )
{
if ( v13 == 1 && !*(_DWORD *)((char *)v7 + 110) )
{
(***(void (__stdcall ****)(signed int, _DWORD))((char *)v7 + 30))(1004, *(float *)((char *)a2 + 78));
v14 = (double)_rand() * 0.00003051850947599719 + 2.0;
*(_DWORD *)((char *)v7 + 110) = timer_set(v14, (int)v7, (int)TDemo::PlungerRelease);
}
}
else
{
...
*(_DWORD *)((char *)v3 + 98) = 0;
*(_DWORD *)((char *)v3 + 94) = 0;
*(_DWORD *)((char *)a2 + 230) = v3;
v4 = (_DWORD *)loader_query_float_attribute(a3, 0, 407);
if ( v4 )
{
*(_DWORD *)((char *)v3 + 78) = *v4;
*(_DWORD *)((char *)v3 + 82) = v4[1];
*(_DWORD *)((char *)v3 + 86) = v4[2];
*(_DWORD *)((char *)v3 + 90) = v4[3];
}
else
{
...
*(_DWORD *)((char *)v3 + 118) = install_wall(v5, v3, (char *)v3 + 5, v12, 0.0, (void *)0x578);
...
*(_DWORD *)((char *)v3 + 122) = install_wall(v7, v3, (char *)v3 + 5, v12, 0.0, (void *)0x57A);
