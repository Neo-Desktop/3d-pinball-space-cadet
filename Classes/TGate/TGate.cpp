...
if ( a2 == 53 )
{
v5 = *(_DWORD **)((char *)this + 26);
*((_BYTE *)this + 5) = 0;
render_sprite_set_bitmap(v5, 0);
loader_play_sound(*(_DWORD *)((char *)v3 + 82));
}
else if ( a2 == 54 || a2 == 1024 )
{
v4 = *(_DWORD *)((char *)this + 34);
*((_BYTE *)this + 5) = 1;
render_sprite_set_bitmap(*(_DWORD **)((char *)this + 26), *(_DWORD *)(*(_DWORD *)(v4 + 4) + 8));
if ( a2 == 54 )
loader_play_sound(*(_DWORD *)((char *)v3 + 78));
}
