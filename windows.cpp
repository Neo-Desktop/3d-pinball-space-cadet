...
if ( !__defaultmatherr )
___setusermatherr(check_expiration_date);
_setdefaultprecision();
_initterm(&__xi_a, &__xi_z);
v18 = _newmode;
v14 = ___getmainargs(&v15, &v16, &v17, _dowildcard, &v18);
...
// 10012BC: using guessed type int __cdecl ___getmainargs(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
// 10012C4: using guessed type int __cdecl ___setusermatherr(_DWORD);
// 10012D0: using guessed type int ___p__fmode(void);
// 10012D4: using guessed type int __cdecl ___set_app_type(_DWORD);
// 100134C: using guessed type int ___p__commode(void);
// 10211AE: using guessed type int __cdecl _initterm(_DWORD, _DWORD);
// 1024890: using guessed type int __defaultmatherr;
// 1027BFC: using guessed type int _dowildcard;
// 1027C00: using guessed type int _newmode;
// 1027C04: using guessed type int _commode;
// 1028298: using guessed type int __onexitend;
// 102829C: using guessed type int __onexitbegin;
// 10282A0: using guessed type int _adjust_fdiv;
