...
(**(void (__stdcall ***)(signed int, _DWORD))dword_1023D0C)(19, 0.0);
...
*(_DWORD *)((char *)dword_1025040 + 318) = 1;
(**(void (__stdcall ***)(signed int, _DWORD))dword_1023ABC)(9, 60.0);
...
*(_DWORD *)((char *)dword_1025040 + 310) = 1;
(**(void (__stdcall ***)(signed int, _DWORD))dword_1023AC4)(9, 60.0);
...
(**(void (__stdcall ***)(signed int, _DWORD))dword_1023940)(9, 60.0);
(**(void (__stdcall ***)(signed int, _DWORD))dword_10239D0)(9, 60.0);
(**(void (__stdcall ***)(signed int, _DWORD))dword_1023AB4)(9, 60.0);
...
(**(void (__stdcall ***)(signed int, _DWORD))dword_1023ACC)(19, 0.0);
...
v1 = *(_DWORD *)((char *)dword_1025040 + 342);
if ( v1 == 2 )
{
table_set_multiball(a1);
*(_DWORD *)((char *)dword_1025040 + 342) = 0;
}
else
{
*(_DWORD *)((char *)dword_1025040 + 342) = v1 + 1;
(*(void (**)(void))(*(_DWORD *)dword_1023DAC + 20))();
v2 = get_rc_string(1, 0);
TTextBox::Display(dword_1023E1C, a1, v2, 2.0);
(***(void (__stdcall ****)(signed int, _DWORD))((char *)dword_1025040 + 222))(1016, 0.0);
}
}
...
++*(_DWORD *)((char *)dword_1025040 + 334);
(*(void (**)(void))(*(_DWORD *)dword_1023D44 + 20))();
